...
estilosideales=xlsread(basedatos,4,celdasestilos);
...
celdasestilos1='C1363:CD1363';
%celdasestilos15='C2:CD16';
%celdasestilos1360='C2:CD1361';
%celdasestilosp='B40:CB6';

estu1=xlsread(basedatos,3,celdasestilos1);
%estu15=xlsread(basedatos,3,celdasestilos15);
%estu1360=xlsread(basedatos,3,celdasestilos1360);
%estup=xlsread(basedatos,5,celdasestilosp);
%estup se utilizó como los posibles vectores
