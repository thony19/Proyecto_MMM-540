...
inteligenciasideales=xlsread(basedatos,4,celdasinteligencias);
...
estup=xlsread(basedatos,6,celdasinteligenciasp);
...
%celdasinteligenciasp='B12:CC12';

%estui1=xlsread(basedatos,3,celdasinteligencias1);
%estui15=xlsread(basedatos,3,celdasinteligencias15);
estui1360=xlsread(basedatos,3,celdasinteligencias1360);
%estuip=xlsread(basedatos,6,celdasinteligenciasp);
%estuip se utilizó como los posibles vectores
